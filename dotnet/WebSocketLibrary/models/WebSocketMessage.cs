...
public class WebSocketMessage {
    ...
    public static WebSocketMessage CreateBinaryMessage(byte[] data) => new(WebSocketMessageType.Binary, data);
    ...
    public string? GetTextContent() => MessageType is WebSocketMessageType.Text
