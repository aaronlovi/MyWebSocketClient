...
public class WebSocketHandlerTests {
    ...
    public WebSocketHandlerTests() {
        ...
        _ = _mockOptions.Setup(o => o.Value).Returns(_options);
    ...
    public async Task HandleConnectionAsync_ClientConnects_RaisesClientConnectedEvent() {
        // Arrange
        _ = _mockWebSocket.Setup(ws => ws.State).Returns(WebSocketState.Open);
        _ = _mockWebSocket.Setup(ws => ws.ReceiveAsync(It.IsAny<ArraySegment<byte>>(), It.IsAny<CancellationToken>()))
        ...
        try {
            // Act
            Task task = _webSocketHandler.HandleConnectionAsync(_mockHttpContext.Object, _mockWebSocket.Object, CancellationToken.None);
            ...
            _ = _mockWebSocket.Setup(ws => ws.State).Returns(WebSocketState.Closed);
        }
    }
